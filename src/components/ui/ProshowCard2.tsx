    ...
    >
      <CCardBody className="py-2 md:py-10 text-center">
        ...
        ">
          ...
          <br />
          Emphasizes the live band experience
    ...
    >
      <CCardBody className="py-2 md:py-9 px-3 text-center">
        ...
        ">
          ...
          <br />
         Highlights the energy and beats of the music
  ...
  <CCard className="w-full bg-transparent border border-white/20 rounded-2xl shadow-md">
    <CCardBody className="py-8 px-10 min-h-[50px] md:min-h-[50px]">
      <span className="text-white/90 text-base md:text-lg lg:text-xl leading-relaxed">
        An immersive night of live music, powerful vocals, and unforgettable melodies that move every soul.
      </span>
    </CCardBody>
  </CCard>
</ScrollAnimate>
