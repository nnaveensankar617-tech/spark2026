...
export const HeroParallax = ({
  ...
  const springConfig = { stiffness: 200, damping: 30, bounce: 70 };
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      <a href={product.link} className="block group-hover/product:shadow-xl group-hover/product:shadow-pink-500/50 transition-all duration-300 rounded-xl overflow-hidden">
        <img
